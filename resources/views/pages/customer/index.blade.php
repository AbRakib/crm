            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="lead-heading-top d-flex align-items-center justify-content-center mb-5">
                            <!-- search bar start -->
                            ...
                            <div class="top-button">
                                <button class="lead-button btn btn-primary" onclick="showCustomerModal()">Add
                                    Customer</button>
                            </div>
                            <!-- lead add button end -->
                        </div>
